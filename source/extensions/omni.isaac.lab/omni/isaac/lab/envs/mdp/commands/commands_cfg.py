...
@configclass
class UniformPoseCommandCfg(CommandTermCfg):       # ものを叩く運動についての設定
    ...
    goal_pose_visualizer_cfg.markers["frame"].scale = (0.1, 0.1, 0.1)  # ゴール位置の視覚的な大きさ
    current_pose_visualizer_cfg.markers["frame"].scale = (0.1, 0.1, 0.1)  # 手先位置の視覚的な大きさ
