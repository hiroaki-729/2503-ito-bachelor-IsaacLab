...
UR10_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        ...
        usd_path=f"/home2/isaac-env/isaaclab/lib/python3.10/site-packages/isaacsim/extscache/omni.importer.urdf-1.14.1+106.0.0.lx64.r.cp310/data/urdf/robots/ur10/urdf/reach_ur10/reach_ur10.usd",
